...
> 最終更新: 2026-04-05（story-022/023追加・catchphrase運営編集方式・messageフィールド整理）
...
- **実投稿**: 9件（story-005, 016, 017, 018, 019, 020, 021, 022, 023）
...
| `/ogp/[id].png` | 体験談別OGP画像・日本語（23件分） |
| `/ogp/[lang]/[id].png` | 体験談別OGP画像・多言語版（23件×7言語）翻訳済みキャッチコピー・言語別サイト名を使用 |
